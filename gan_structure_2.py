...
class DualEncoderUNet_CBAM_SA_Small(nn.Module):
    def __init__(self, in_channels=3, base_ch=32):
        ...
        self.bottleneck = nn.Sequential(  # utilizado a partir da época 9
            EncoderBlock(base_ch * 4, base_ch * 4),  # utilizado a partir da época 9
            SelfAttention(base_ch * 4),  # utilizado a partir da época 9
            ResidualBlock(base_ch * 4)  # utilizado a partir da época 9
        )
